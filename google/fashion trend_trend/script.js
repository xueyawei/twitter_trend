...
d3.csv('../data/fashion trend/multiTimeline.csv',row,function(data){
    ...
    g.append('text')
        ...
        .attr("fill", "black")
        .text('Interest over Time: Oct 25 2015 ---> Oct 16 2016');
...
function draw_country(){
    ...
    d3.csv('../data/fashion trend/geoMap.csv',parse_1,function(data){
        console.log("Country:");
        console.log(data);
...
function draw_topic(){
    ...
    d3.csv('../data/fashion trend/relatedEntities.csv',parse_2,function(data){
        console.log("Topic:");
        console.log(data);
...
function draw_topic_rising(){
    d3.csv('../data/fashion trend/rising_topic.csv',parse_3,function(data){
...
function draw_query(){
    ...
    d3.csv('../data/fashion trend/relatedQueries.csv',parse_2,function(data){
        console.log("Topic:");
        console.log(data);
...
function draw_query_rising(){
    d3.csv('../data/fashion trend/rising_query.csv',parse_3,function(data){
        console.log("Topic_Rising:");
        console.log(data);
